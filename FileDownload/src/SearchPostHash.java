...
/**
 * Servlet implementation class SearchPostHash
 */
@WebServlet("/SearchPostHash")
public class SearchPostHash extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchPostHash() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String search_hash = request.getParameter("search_hash");
