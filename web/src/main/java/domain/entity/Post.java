...
public class Post {
    ...
    public Post(String title, String content, String creatorUserId) {
    ...
    public Post(String id, String creatorUser, String title, String content, String lastModified, String creationDate,String attachmentId, boolean isUpdated) {
        this.id = id;
