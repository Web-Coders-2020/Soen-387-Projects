...
public class PostRepository {
    ...
    public void save(Post post)
    {
        try {
            ...
            statement.execute("insert into Post(id,creatorUser,title,content,lastModified,creationDate,attachmentId,isUpdated) " +
                    "values(" +
                    "'"+post.getId()+"' , " +
    ...
    private List<Post> fetchPostsWithSelect(String selectSql) {
        try {
            ...
            while(resultSet.next())
            {
                ...
                posts.add(new Post(id,creatorUser,title,content,lastModified,creationDate,attachmentId,isUpdated));
            }
    ...
    public List<Post> fetch(String creatorId, Date startDate , Date endDate , List<String> hashTags)
    {
        ...
        String selectSql = "select * from post where " +
